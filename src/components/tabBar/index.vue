      ...
      <div class="navs">
        ...
        <el-dropdown @command="blockCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="/blockchain">顶级账户</el-dropdown-item>
            <el-dropdown-item divided command="/tsx">查看Txns</el-dropdown-item>
            <el-dropdown-item command="/blockcheck">查看区块</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
        ...
        <el-dropdown>
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item divided>开发者API</el-dropdown-item>
        ...
        <el-dropdown>
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>DAO可治理参数</el-dropdown-item>
            <el-dropdown-item divided>DAO基金会地址</el-dropdown-item>
            <el-dropdown-item>提交代币LOGO</el-dropdown-item>
            <el-dropdown-item>提交上币申请</el-dropdown-item>
            <el-dropdown-item>RPC信息</el-dropdown-item>
            <el-dropdown-item>水龙头</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
